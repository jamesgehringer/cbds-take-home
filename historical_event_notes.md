...
- I grouped the data by country and year, and got a sum, to get a measure of total enrollement per country.
...
- I generated a difference between 2010 and 2000 total enrollement numbers and plotted it on the map bellow, curious to see if there were any countries that had decreases in this time window.
...
- The original version of this figure was really tough to really tell anything, because China's change was over 8 million, and India's was around 3.6 million, and all other countries we about 2 million and less.
    - Another point in the collumn for normalizing by country population.
...
- The effect was so drastic, and followed some of the outliers in the origianl line plot, that suggested to me that I needed to check country.
...
- In the interactive version of the plot, I was able to zoom in and explore a little further.
